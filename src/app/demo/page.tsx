...
import { Heart, MessageCircle, User, Settings, LogIn, Plus, Package, Sparkles, ArrowLeft } from 'lucide-react'
...
export default function DemoPage() {
  ...
  const [items, setItems] = useState<Item[]>(mockItems) // Mock items kullan
  ...
  // Demo mode - mock items zaten yüklü, API çağrısı yok
  ...
  const handleItemClick = (item: Item) => {
    // Demo modda item detayları gösterme (opsiyonel)
    console.log('Demo item clicked:', item)
  }
      ...
      <main className="max-w-md mx-auto px-4 pb-24">
        {items.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500">Demo ürünleri yükleniyor...</p>
          </div>
        ) : (
          <div className="mt-4">
            <SwipeStack
