  ...
  return (
    <div className="h-screen overflow-hidden bg-linear-to-br from-pink-50 via-purple-50 to-indigo-50 flex flex-col">
      <div className="flex-1 flex flex-col w-full max-w-md lg:max-w-lg xl:max-w-xl mx-auto overflow-hidden">
        {/* Header */}
        <header className="shrink-0 bg-white/95 backdrop-blur-md shadow-sm border-b border-white/20 pt-safe">
        ...
        {/* Chat List */}
        <div className="flex-1 overflow-y-auto overscroll-contain p-4 bg-transparent">
          {matches.length > 0 ? (
